		 ...
		 int main(VOID)
{
  ...
  /*=============================================*/
  {
    ...
    int part8(VOID);
#ifdef PRINT
    printf("part1: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part2();
#ifdef PRINT
    ...
    part3();
#ifdef PRINT
    printf("part3: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part4();
#ifdef PRINT
    printf("part4: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part5();
#ifdef PRINT
    printf("part5: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part6();
#ifdef PRINT
    printf("part6: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part7();
#ifdef PRINT
    printf("part7: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    part8();
#ifdef PRINT
    printf("part8: %d %d %d %d\n", ErrCnt[0], ErrCnt[1], ErrCnt[2], ErrCnt[3]);
#endif
    return 0;
  }
}
