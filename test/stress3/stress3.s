...
;;
	c0    cmpeq $b0.3 = $r0.4, $r0.6
;;
	c0    cmpge $b0.3 = $r0.4, $r0.6
;;
	c0    cmpgeu $b0.3 = $r0.4, $r0.6
;;
	c0    cmpgt $b0.3 = $r0.4, $r0.6
;;
	c0    cmpgtu $b0.3 = $r0.4, $r0.6
;;
	c0    cmple $b0.3 = $r0.4, $r0.6
;;
	c0    cmpleu $b0.3 = $r0.4, $r0.6
;;
	c0    cmplt $b0.3 = $r0.4, $r0.6
;;
	c0    cmpltu $b0.3 = $r0.4, $r0.6
;;
	c0    cmpne $b0.3 = $r0.4, $r0.6
;;
	c0    nandl $b0.3 = $r0.4, $r0.6
;;
	c0    norl $b0.3 = $r0.4, $r0.6
;;
	c0    orl $b0.3 = $r0.4, $r0.6
;;
	c0    andl $b0.3 = $r0.4, $r0.6
;;
