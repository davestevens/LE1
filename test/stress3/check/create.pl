...
open FILE, "> stress3.s" or die "Could not open file\n";

print FILE $top_section;
foreach $op (@ops)
{
    print FILE "\tc0    $op \$b0.3 = \$r0.4, \$r0.6\n\;\;\n";
}
print FILE $bottom_section;

close FILE;

#system("/home/elds2/vex-3.41/lib/s2cs stress3.s stress3.cs.c -show_bundle_counts -trace_icache -trace_memory -runtime_icache_cfg -little_endian");
