...
open FILE, "> stress2.s" or die "Could not open file\n";
...
#system("/home/elds2/vex-3.41/lib/s2cs stress2.s stress2.cs.c -show_bundle_counts -trace_icache -trace_memory -runtime_icache_cfg -little_endian");
